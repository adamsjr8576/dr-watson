...
describe('postMessage', () => {
  const mockMessage = 'I am happy because it is week 6!';
  const mockResponse = {
    message: "That is really awesome.  Good for you!"
  };
  ...
  it('should return an error (SAD)', () => {
    ...
    expect(postMessage(mockMessage)).rejects.toEqual(Error('Please enter a message before submitting.'))
  });
